...
In order to support loading of multiple wallets in ojacoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ojacoin.cpp.
...
Changes to ojacoin.cpp
----------------------
ojacoin.cpp is the entry point into ojacoin-qt, and as such, will require some minor modifications to provide hooks for
