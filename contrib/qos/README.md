...
This means one can have an always-on ojacoind instance running, and another local ojacoind/ojacoin-qt instance which connects to this node and receives blocks from it.
