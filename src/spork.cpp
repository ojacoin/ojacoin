...
// ojacoin: on startup load spork values from previous session if they exist in the sporkDB
...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_17_INPUT_BLACKLIST_MAIN_ADDRESS) r = SPORK_17_INPUT_BLACKLIST_MAIN_ADDRESS_DEFAULT;
        if (nSporkID == SPORK_18_INPUT_BLACKLIST_MULTI_ADDRESS) r = SPORK_18_INPUT_BLACKLIST_MULTI_ADDRESS_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_17_INPUT_BLACKLIST_MAIN_ADDRESS") return SPORK_17_INPUT_BLACKLIST_MAIN_ADDRESS;
    if (strName == "SPORK_18_INPUT_BLACKLIST_MULTI_ADDRESS") return SPORK_18_INPUT_BLACKLIST_MULTI_ADDRESS;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_17_INPUT_BLACKLIST_MAIN_ADDRESS) return "SPORK_17_INPUT_BLACKLIST_MAIN_ADDRESS";
    if (id == SPORK_18_INPUT_BLACKLIST_MULTI_ADDRESS) return "SPORK_18_INPUT_BLACKLIST_MULTI_ADDRESS";
