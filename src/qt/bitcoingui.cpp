...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zECA"));
...
//    }
    ...
    connect(webmainAction, SIGNAL(triggered()), this, SLOT(webmainActionClicked()));
