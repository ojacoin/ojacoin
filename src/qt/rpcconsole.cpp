                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzECAPathCustom = GetArg("-zecabackuppath", "");
    ...
    if(!strzECAPathCustom.empty()) {
        ui->wallet_customzecabackuppath->setText(QString::fromStdString(strzECAPathCustom));
        ui->wallet_customzecabackuppath_label->setVisible(true);
        ui->wallet_customzecabackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzECAPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the ojacoin RPC console.") + "<br>" +
