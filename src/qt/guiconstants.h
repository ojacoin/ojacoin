...
/* ojacoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "ojacoin"
#define QAPP_ORG_DOMAIN "ojacoinproject.org"
#define QAPP_APP_NAME_DEFAULT "ojacoin-Qt"
#define QAPP_APP_NAME_TESTNET "ojacoin-Qt-testnet"
