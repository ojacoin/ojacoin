...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("ojacoin ojacoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ojacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ojacoin transaction") + "\n" +
                               "  ojacoin-tx [options] -create [commands]   " + _("Create hex-encoded ojacoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ojacoin transaction
