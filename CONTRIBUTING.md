Contributing to ojacoin Core
============================

The ojacoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ojacoin Core project, and is not to be
confused with overall ojacoin Network Protocol consensus changes.

Whether a pull request is merged into ojacoin Core rests with the project merge
...
Patches that change ojacoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the ojacoin consensus, it must have been
...
The project leader is the release manager for each ojacoin Core release.
